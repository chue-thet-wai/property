                            ...
                            <tr>
                                ...
                                <td>
                                    @if (array_key_exists("list",$permission[$value->id]))
                                        {{ Form::checkbox('permission[]', $permission[$value->id]['list'], false, array('class' => 'name')) }}
                                    @endif
                                </td>
                                <td>
                                    @if (array_key_exists("create",$permission[$value->id]))
                                        {{ Form::checkbox('permission[]', $permission[$value->id]['create'], false, array('class' => 'name')) }}
                                    @endif
                                </td>
                                <td>
                                    @if (array_key_exists("view",$permission[$value->id]))
                                        {{ Form::checkbox('permission[]', $permission[$value->id]['view'], false, array('class' => 'name')) }}
                                    @endif
                                </td>
                                <td>
                                    @if (array_key_exists("edit",$permission[$value->id]))
                                        {{ Form::checkbox('permission[]', $permission[$value->id]['edit'], false, array('class' => 'name')) }}
                                    @endif
                                </td>
                                <td>
                                    @if (array_key_exists("delete",$permission[$value->id]))
                                        {{ Form::checkbox('permission[]', $permission[$value->id]['delete'], false, array('class' => 'name')) }}
                                    @endif
                                </td>                               
                            </tr>
                            @endforeach
