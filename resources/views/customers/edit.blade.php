...
@section('cardbody')
    ...
    @endforeach
    {!! Form::model($customer, array('method' => 'PATCH','route' => ['customers.update', $customer->id],'enctype'=>'multipart/form-data')) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 py-4">
            <a class="btn btn-primary px-4 py-2" href="{{ route('customers.index') }}"> Back</a>
